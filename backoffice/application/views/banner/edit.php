                  ...
                  <form action="<?=base_url().$_CMD.'/'.$task?>" method="post" name="adminTable" id="adminTable"  class="form-horizontal"  >
                   ...
                   <table class="table" >
                     ...
                     <tr>
                         <td colspan="2">
                          <div class="form-group">
	                        <label class="col-sm-2 right_b">แบนเนอร์<font class="req">*</font></label>
	                        <div class="col-sm-8 col-md-4 pad_3">
	                             <?=getImageUploadToolBanner( $sid, $uploadKey, $_CMD, $table['file'], $user['id'])?>
	                             <span style="color: rgb(1, 93, 155);font-weight: bold;">Image reasonable size 860 x 300 pixel.</span>
	                        </div>
	                      </div>        
                    ...
                    <tr>
                      <td colspan="2">
	                      <div class="form-group" id="url">
	                        <label class="col-sm-2 right_b">ลำดับแสดงผล <font class="req">*</font></label> 
	                        <div class="col-sm-8 col-md-4 pad_3">
	                             
	                             <select name="seq" class="form-control input-sm" style="width: 60px;">
	                             	<?php for($i=$seq;$i>=1;$i--){
	                             			$sel = ($frm["seq"]==$i) ? ' selected="selected"' : '' ;
	                             		?>
                    ...
                    <tr>
                      <td colspan="2">
	                      <div class="form-group" id="url">
	                        <label class="col-sm-2 right_b" >ลิ้งค์</label> 
	                        <div class="col-sm-8 col-md-4 pad_3">
	                            <input type="text" class="form-control input-sm" placeholder="" name="url"  value="<?=@$frm["url"]?>">
	                           <font style="color: red;">**หากไม่มีลิ้งค์ กรุณาปล่อยว่างไว้</font>
	                        </div>
	                      </div>
                      </td> 
                    </tr>
