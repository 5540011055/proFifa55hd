	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="panel panel-grey font13" >
                    ...
                    <div class="col-xs-12  col-sm-12 col-md-12 form-cid" style="float: right;padding-right: 0px; padding-left: 0px;">       
                       <form name="frm-search" method="post">            
                        <span class="input-group input-group-sm" style="max-width:322px; vertical-align:middle;float: right;" data-original-title="" title="">
	                 		 ...
	                 		 <?=getAllCID2(0, $table['category'], @$_REQUEST['cid'])?>
