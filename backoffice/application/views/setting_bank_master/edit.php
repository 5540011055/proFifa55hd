                     ...
                     <tr>
                      <td colspan="2">
	                      <div class="form-group" id="cate_name">
	                        <label class="col-sm-2 right_b" >ชื่อธนาคาร<font class="req">*</font> <?=getLangImg("th");?></label> 
	                        <div class="col-sm-8 col-md-4 pad_3">
	                            <input type="text" class="form-control input-sm" placeholder="กรุณากรอกข้อมูล" name="cate_name"  value="<?=@$frm["cate_name"]?>">
	                        </div>
	                      </div>
                      </td> 
                    </tr>
 					...
 					<tr>
                      <td colspan="2">
	                      <div class="form-group" id="cate_name_en">
	                        <label class="col-sm-2 right_b" >ชื่อธนาคาร<font class="req">*</font> <?=getLangImg("en");?></label> 
	                        <div class="col-sm-8 col-md-4 pad_3">
	                            <input type="text" class="form-control input-sm" placeholder="กรุณากรอกข้อมูล" name="cate_name_en"  value="<?=@$frm["cate_name_en"]?>">
	                        </div>
	                      </div>
                      </td> 
                    </tr>
                    ...
                    <tr>
                      <td colspan="2">
	                      <div class="form-group" id="short_name">
	                        <label class="col-sm-2 right_b" >ตัวย่อ<font class="req">*</font> </label> 
	                        <div class="col-sm-8 col-md-4 pad_3">
	                            <input type="text" class="form-control input-sm" placeholder="กรุณากรอกข้อมูล" name="short_name"  value="<?=@$frm["short_name"]?>">
	                        </div>
	                      </div>
                      </td> 
                    </tr>
                    ...
                    <tr>
                         <td colspan="2">
                          <div class="form-group">
	                        <label class="col-sm-2 right_b">ภาพประกอบ<font class="req">*</font></label>
	                        <div class="col-sm-8 col-md-4 pad_3">
