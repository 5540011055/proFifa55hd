			...
			<div class="panel panel-grey font13">
                  ...
                  <form action="<?=base_url().$_CMD.'/'.$task?>" method="post" name="adminTable" id="adminTable"  class="form-horizontal"  >
                   ...
                   <table class="table" >
                    ...
                    <tr>
                      <td colspan="2">
	                      <div class="form-group" id="seq">
	                        <label class="col-sm-2 right_b" >เลขหน้า<font class="req">*</font></label> 
	                        <div class="col-sm-8 col-md-4 pad_3">
                     ...
                     <tr>
                         <td colspan="2">
                          <div class="form-group">
	                        ...
	                        <div class="col-sm-10 col-md-8 pad_3">
	                             <?=getImageUploadToolNotProfile( $sid, $uploadKey, $_CMD, $table['file'], $user['id'])?>
	                        </div>
	                      </div>        
