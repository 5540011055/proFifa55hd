<?PHP
    function getAllCategory_personal( $currentId, $tableName, $currentParentId='', $cateId=''){        
        $db					= getDBO();
    ...
    function getAllCategory_personal_multiRows( $currentId, $tableName, $currentParentId='', $cateId=''){        
        $db					= getDBO();
        $db->setQuery(" SELECT          id, cate_name
                        FROM            {$tableName} 
                        WHERE           status='1'                  AND 
