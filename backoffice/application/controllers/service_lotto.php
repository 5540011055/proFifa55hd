...
class Service_lotto extends CI_Controller {
    /**
     *
    ...
    public function showList(){
    	...
    	$cid = 3; /* for detail data page */
    	
    	
        $this->data['showMainSearch']   = true;
        $this->data['menuName']     =  'เพิ่มบริการหวยออนไลน์';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
    ...
    public function add(){
        ...
        $frm['cid'] = 3; /* for detail data page */
