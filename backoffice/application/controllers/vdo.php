...
class Vdo extends CI_Controller {
     ...
     */
    public $_TABLE              = Array(
        'info'              => 'vdo_information',
        'file'              => 'vdo_attactments',
        'category'          => 'vdo_category'
    );
    public $data                = Array(
        '_CMD'              => 'vdo',
        'body'              => '',
    ...
    public function showList(){
        ...
        $this->data['menuName']     =  'เพิ่มข้อมูลวิดีโอ';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
       ...
       // $dropdown                   = (@$_REQUEST['cid']) ? " AND i.cid = '".$_REQUEST['cid']."' " : "";
        ...
        $query                      = " SELECT i.id,i.vdo_source,CONCAT(i.cid,'__{$this->_TABLE['category']}') as cid,i.status,CONCAT(i.id,'__{$this->_TABLE['info']}')  As subject_temp,CONCAT(i.create_date,'__',i.create_by) As cbydate,
        ...
        $showField      = Array( 
        	...
        	'subject_temp'     => Array(
        		'align'         => 'left',
        		'fieldname'     => 'หัวข้อวีดีโอ',
        		'eval'          => 'change_subject',		
        	),
        		
        	'vdo_source'     => Array(
        				'align'         => 'center',
        				'fieldname'     => 'แหล่งที่มา',
        			    'eval'			=> 'getVdoSource'
        	 ),
    ...
    public function add(){
	    ...
	    $this->data['menuName']      = "เพิ่มวีดีโอ";
    ...
    public function insert(){
        ...
        $obj->vdo_source 		    = request('vdo_source');
