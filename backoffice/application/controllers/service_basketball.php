...
class Service_basketball extends CI_Controller {
    /**
     *
    ...
    public function showList(){
    	...
    	$cid = 4; /* for detail data page */
    	
    	
        $this->data['showMainSearch']   = true;
        $this->data['menuName']     =  'เพิ่มบาสเก็ตบอลออนไลน์';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
    ...
    public function add(){
	    ...
	    $this->data['menuName']      = 'เพิ่มบริการบาสออนไลน์';
        ...
        $frm['cid'] = 4; /* for detail data page */
