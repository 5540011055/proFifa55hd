...
class Service_boxxing extends CI_Controller {
    /**
     *
    ...
    public function showList(){
    	...
    	$cid = 5; /* for detail data page */
    	
    	
        $this->data['showMainSearch']   = true;
        $this->data['menuName']     =  'เพิ่มมวยออนไลน์';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
    ...
    public function add(){
	    ...
	    $this->data['menuName']      = 'เพิ่มบริการมวยออนไลน์';
        ...
        $frm['cid'] = 5; /* for detail data page */
