...
class Service_sport extends CI_Controller {
    /**
     *
    ...
    public function showList(){
        ...
        $this->data['menuName']     =  'เพิ่มบริการกีฬาออนไลน์';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
    ...
    public function setNewSeq(){
    	...
    	$db->setQuery("SELECT id,seq FROM {$this->_TABLE['info']} WHERE  status = '1' AND cid = '1' ORDER BY seq ASC ");
    	$rs = $db->loadAssocList();
