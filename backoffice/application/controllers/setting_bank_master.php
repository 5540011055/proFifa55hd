...
class Setting_bank_master extends CI_Controller {
    /**
     *
    ...
    public function showList(){
        ...
        $this->data['menuName']     =  'เพิ่มธนาคาร ';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
       ...
       $Qsearch  = ($search || @$_REQUEST["key"] || @$_REQUEST["order_by"] )  ? '&search='.@$search.'&key='.@$_REQUEST["key"].'&order_by='.@$_REQUEST["order_by"] : '';
        ...
        $query                      = " SELECT i.id,i.short_name,i.display_image,i.status,CONCAT(i.id,'__{$this->_TABLE['info']}')  As subject_temp,CONCAT(i.create_date,'__',i.create_by) As cbydate, 
    ...
    public function add(){
	    ...
	    $this->data['menuName']      = "เพิ่มรายชื่อธนาคาร ";
    ...
    public function insert(){
        ...
        $obj->short_name            = escape_str(strip_tags(request('short_name')));
