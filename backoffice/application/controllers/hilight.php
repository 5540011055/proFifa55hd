...
class Hilight extends CI_Controller {
     ...
     */
    public $_TABLE              = Array(
        'info'              => 'hilight_information',
        'file'              => 'hilight_attactments',
        'category'          => 'hilight_category'
    );
    public $data                = Array(
        '_CMD'              => 'hilight',
        'body'              => '',
    ...
    public function showList(){
        ...
        $placeholder                = 'ข้อมูลข่าวสาร';
        
        
       // $dropdown                   = (@$_REQUEST['cid']) ? " AND i.cid = '".$_REQUEST['cid']."' " : "";
         
        $Qsearch  = ($search || @$_REQUEST["key"] || @$_REQUEST["order_by"] || @$_REQUEST["cid"])  ? '&search='.@$search.'&key='.@$_REQUEST["key"].'&order_by='.@$_REQUEST["order_by"] : '';
    ...
    public function add(){
	    ...
	    $this->data['menuName']      = "เพิ่มไฮไลท์";
