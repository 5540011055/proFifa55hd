...
class Withdraw_home extends CI_Controller {
    /**
     *
    ...
    public function showList(){
        ...
        $this->data['menuName']     =  'เพิ่มข้อมูลแสดงผลหน้าแรก';
        $db                         = getDBO();    
        $limit       = $this->maxRows;
        $adjacent    = 2;
    ...
    public function add(){
	    ...
	    $this->data['menuName'] = 'เพิ่มการแสดงผลหน้าแรก (ฝาก - ถอน)';
