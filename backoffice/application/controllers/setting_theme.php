...
class Setting_theme extends CI_Controller {
    /**
     *
    ...
    public $_TABLE              = Array(
    	...
    	'theme'				=> 'cpanel_configuration_theme'
    );
    public $data                = Array(
        '_CMD'              => 'setting_theme',
        'body'              => '',
    ...
    public function edit(){
    	...
    	$this->data['menuName'] = lang('setting theme', 'setting theme');
    	$this->data['iconName'] = '<i class="fa fa-cogs" aria-hidden="true"></i>';
    	
        $db                     = getDBO();
        $db->setQuery("SELECT * FROM {$this->_TABLE['theme']} ");
        $rs                     = $db->loadAssocList();
        $rs                     = @$rs[0];
    ...
    public function update(){         
        ...
        $db                         = getDBO();
        $updated                    = $db->updateObject($this->_TABLE['theme'], $obj, 'id');
    ...
    public function setTheme(){
    	...
    	$skin_sel       = $_POST["skin_sel"];
    	$id_sel        = $_POST["id_sel"];
    	
    	
    	$db->setQuery(" UPDATE {$this->_TABLE['theme']} SET  theme_skin  = '{$skin_sel}' WHERE id ='{$id_sel}'");
    	$db->query();
