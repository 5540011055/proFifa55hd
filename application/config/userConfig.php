<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Database{
        ...
        public static $user     = "fifahdco_user";
        public static $pass     = "YK3dcF0S0u4wvz3N";
       
        public static $port             = 3306;
        public static $dbName           = "fifahdco_db";
    ...
    /* Set For Popup */
    if(@$_SESSION['user']['popup']=='close'){
    	$_ENV['popup_state'] = 'close';
    }else{
    	$_ENV['popup_state'] = 'open';
    }
